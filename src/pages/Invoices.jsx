...
const Invoices = () => {
    ...
    return (
        <div className="p-8 lg:p-12 h-screen overflow-y-auto no-scrollbar bg-transparent relative">
            ...
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#d946ef]/5 rounded-full blur-[120px] pointer-events-none" />
            ...
            >
                <div className="mb-16">
                    ...
                    <h1 className="text-5xl lg:text-7xl font-black text-gray-900 tracking-tighter mb-6 leading-none">Financial <span className="text-[#8b5cf6]">Registry.</span></h1>
                    <p className="text-gray-500 font-bold text-xl tracking-tight max-w-2xl">Access immutable trace logs for all neural energy transactions and node provisioning fees.</p>
                </div>

                <div className="bg-white/40 backdrop-blur-3xl rounded-[64px] border border-white/60 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.05)] overflow-hidden">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-white/40 bg-white/20">
                                    ...
                                    <th className="px-12 py-10 text-[11px] font-black uppercase tracking-[0.3em] text-gray-400 text-right">Data Hub</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-white/20">
                                    ...
                                    <tr className="hover:bg-white/30 transition-all group">
                                        <td className="px-12 py-10">
                                            <div className="flex items-center gap-6">
                                                <div className="w-16 h-16 rounded-[28px] bg-white flex items-center justify-center text-[#8b5cf6] shadow-2xl border border-white group-hover:rotate-6 transition-all duration-500">
                                                    <CreditCard size={24} />
                                                </div>
                                                <div>
                                                    <div className="font-black text-gray-900 text-lg tracking-tight mb-1">Genesis Configuration</div>
                                        ...
                                        <td className="px-12 py-10">
                                            <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl text-[10px] font-black bg-white/60 border border-white/80 text-[#8b5cf6] uppercase tracking-[0.15em] shadow-sm">
                                ...
                                {payments.map((payment, index) => (
                                    ...
                                    >
                                        <td className="px-12 py-10">
                                            <div className="flex items-center gap-6">
                                                <div className="w-16 h-16 rounded-[28px] bg-white flex items-center justify-center text-[#8b5cf6] shadow-2xl border border-white group-hover:rotate-6 transition-all duration-500 relative">
                                                    <FileText size={24} />
                                                    <div className="absolute -top-1 -right-1 w-4 h-4 bg-[#8b5cf6] rounded-full border-2 border-white" />
                                                </div>
                                                <div>
                                                    <div className="font-black text-gray-900 text-lg tracking-tight mb-1">{payment.planName}</div>
                                        ...
                                        <td className="px-12 py-10 text-right">
                                            <button
                                                ...
                                                className="inline-flex items-center gap-3 px-8 py-4 bg-white border border-white/60 hover:border-[#8b5cf6] text-gray-900 rounded-[24px] font-black text-[10px] uppercase tracking-[0.2em] transition-all shadow-xl hover:shadow-[#8b5cf6]/20 hover:scale-105 active:scale-95 group/btn"
                                            >
                ...
                <div className="mt-12 flex justify-center">
                    <div className="px-8 py-4 bg-white/30 backdrop-blur-xl border border-white/50 rounded-full flex items-center gap-4 shadow-sm">
