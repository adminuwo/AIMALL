    ...
    const processQuery = async (text) => {
        ...
        try {
            ...
            const response = await generateChatResponse(
                history,
                text,
                `You are AIVA, powered by A-Series. You are in a video call. 
                 ...
                 GREETING HANDLING:
                 - If the user says "Hello", "Hi", or greets you, introduce yourself briefly as AIVA (an advanced AI assistant) and mention you can see them via the camera. Then ask how you can help.
    ...
    return (
        <div className="fixed inset-0 z-[200] bg-black flex flex-col text-white font-sans">
            ...
            <video
                ...
                playsInline
                muted
                className={`flex-1 w-full h-full object-cover transition-all duration-500 ${isVideoActive ? 'opacity-100' : 'opacity-0'}`}
