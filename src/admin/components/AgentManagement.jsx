    ...
    return (
        ...
        >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tighter mb-1">My Agents</h1>
                                ...
                                <tr>
                                    <td colSpan="4" className="px-10 py-32 text-center opacity-50">
                                        <div className="flex flex-col items-center gap-4">
                                            ...
                                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">No agents found in inventory</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
